...
export const HomeHeader = ({ query, onQueryChange, onSearchSubmit }: HomeHeaderProps) => {
  return (
    <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-4 md:px-8">
      <SiteLogo />
      <form onSubmit={onSearchSubmit} className="relative mx-auto hidden w-full max-w-md sm:block">
